...
class ComputerTest(unittest.TestCase):
    ...
    #         pycom.computer.Computer.Program()
    #         .with_values(
    #             pycom.computer.Computer.Opcode.LDA_ABSOLUTE,
    #             0xBE,
    #             0xEF,
    #         )
    #         .with_value_at(
    ...
    #         )
    #         .with_values(
    #             pycom.computer.Computer.Opcode.STA_ABSOLUTE,
    #             0xBE,
    #             0xEF,
    #         )
    #         .computer()
    ...
    #         pycom.computer.Computer.Program()
    #         .with_value(
    #             pycom.computer.Computer.Opcode.CLC,
    #         )
    #         .computer()
    #     )
    ...
    #         pycom.computer.Computer.Program()
    #         .with_value(
    #             pycom.computer.Computer.Opcode.SEC,
    #         )
    #         .computer()
    #     )
    ...
    #         )
    #         .with_values(
    #             pycom.computer.Computer.Opcode.ADC_IMMEDIATE,
    #             2,
    #         )
    #         .computer()
    #     )
